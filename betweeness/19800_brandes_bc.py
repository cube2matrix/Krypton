...
def buildGraph():
    ...
    num_lines = sum(1 for line in open('/gpfs/courses/cse603/students/xli66/603/graph/300lines/nodes/part-00000'))
    for x in xrange(num_lines):
        V.append(x)

    A = dict((w, []) for w in V)

    with open('/gpfs/courses/cse603/students/xli66/603/graph/300lines/edges/part-00000') as f :
        for line in f:
