...
PROG="/gpfs/user/xli66/Krypton/betweeness/244270_brandes_bc.py"
ARGS="32"
...
# SUBMIT PYSPARK JOB
$SPARK_HOME/bin/spark-submit --conf spark.akka.frameSize=512 --driver-memory 4g --executor-memory 6g --executor-cores $executor_cores --master $MASTER $PROG $ARGS
