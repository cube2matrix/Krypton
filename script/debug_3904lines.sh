...
PROG="/gpfs/user/xli66/Krypton/graph_generator/3904lines_main.py"
ARGS="32"
...
# SUBMIT PYSPARK JOB
$SPARK_HOME/bin/spark-submit --conf spark.akka.frameSize=512 --executor-cores $executor_cores --py-files //gpfs//scratch//xli66//nltk.zip --master $MASTER $PROG $ARGS
