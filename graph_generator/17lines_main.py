...
def main():
    ...
    words = sc.textFile("/gpfs/courses/cse603/students/xli66/603/merge/merged_17lines.tsv").cache()
    ...
    formatNodeID.saveAsTextFile("/gpfs/courses/cse603/students/xli66/603/graph/17lines/nodes")
    ...
    edgesRDD.saveAsTextFile("/gpfs/courses/cse603/students/xli66/603/graph/17lines/edges")
