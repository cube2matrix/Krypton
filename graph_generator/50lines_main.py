...
def main():
    ...
    words = sc.textFile("/gpfs/courses/cse603/students/xli66/603/merge/merged_50lines.tsv").cache()
    ...
    formatNodeID.saveAsTextFile("/gpfs/courses/cse603/students/xli66/603/graph/50lines/nodes")
    ...
    edgesRDD.saveAsTextFile("/gpfs/courses/cse603/students/xli66/603/graph/50lines/edges")
