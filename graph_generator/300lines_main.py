...
def main():
    ...
    words = sc.textFile("/gpfs/courses/cse603/students/xli66/603/merge/merged_300lines.tsv").cache()
    ...
    formatNodeID.saveAsTextFile("/gpfs/courses/cse603/students/xli66/603/graph/300lines/nodes")
